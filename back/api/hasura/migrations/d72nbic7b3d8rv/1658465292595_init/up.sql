...
CREATE SEQUENCE public."TicketAccessToken_id_seq1"
    ...
    NO MAXVALUE
    CACHE 1;
ALTER SEQUENCE public."TicketAccessToken_id_seq1" OWNED BY public."TicketAccessToken".id;
...
CREATE SEQUENCE public."TicketCollection_id_seq1"
    ...
    NO MAXVALUE
    CACHE 1;
ALTER SEQUENCE public."TicketCollection_id_seq1" OWNED BY public."TicketCollection".id;
...
CREATE SEQUENCE public."Transaction_id_seq1"
    ...
    NO MAXVALUE
    CACHE 1;
ALTER SEQUENCE public."Transaction_id_seq1" OWNED BY public."Transaction".id;
...
CREATE SEQUENCE public."UserAccessToken_id_seq1"
    ...
    NO MAXVALUE
    CACHE 1;
ALTER SEQUENCE public."UserAccessToken_id_seq1" OWNED BY public."UserAccessToken".id;
...
CREATE SEQUENCE public."UserNonce_id_seq1"
    ...
    NO MAXVALUE
    CACHE 1;
ALTER SEQUENCE public."UserNonce_id_seq1" OWNED BY public."UserNonce".id;
...
ALTER TABLE ONLY public."TicketAccessToken" ALTER COLUMN id SET DEFAULT nextval('public."TicketAccessToken_id_seq1"'::regclass);
ALTER TABLE ONLY public."TicketCollection" ALTER COLUMN id SET DEFAULT nextval('public."TicketCollection_id_seq1"'::regclass);
ALTER TABLE ONLY public."TicketTokens" ALTER COLUMN id SET DEFAULT nextval('public."TicketTokens_id_seq"'::regclass);
ALTER TABLE ONLY public."Transaction" ALTER COLUMN id SET DEFAULT nextval('public."Transaction_id_seq1"'::regclass);
ALTER TABLE ONLY public."UserAccessToken" ALTER COLUMN id SET DEFAULT nextval('public."UserAccessToken_id_seq1"'::regclass);
ALTER TABLE ONLY public."UserNonce" ALTER COLUMN id SET DEFAULT nextval('public."UserNonce_id_seq1"'::regclass);
